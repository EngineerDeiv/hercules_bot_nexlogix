...
public class VehiclesNavPage {

    public static final Target INPUT_SEARCH = Target.the("Input buscar vehiculo")
            .located(By.xpath("//input[@placeholder='Buscar vehículos...']"));
    ...
    public static final Target BTN_CREAR_VEHICULO = Target.the("Botón Crear vehículo")
            .located(By.xpath("//button[contains(@class,'btn-warning') and contains(normalize-space(.),'Crear vehículo')]"));
